...
A curated list of awesome big data frameworks, resources and other awesomeness. Inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,698 | 🐛 91 | 📅 2026-07-13, [awesome-python](https://github.com/vinta/awesome-python) ⭐ 320,610 | 🐛 18 | 🌐 Python | 📅 2026-09-13, [awesome-ruby](https://github.com/Sdogruyol/awesome-ruby) ⚠️ Archived, [hadoopecosystemtable](http://hadoopecosystemtable.github.io/) & [big-data](http://usefulstuff.io/big-data/).
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,830 | 🐛 284 | 🌐 Rust | 📅 2026-09-14 - Kubernetes-native stream processing platform.
...
* [Ray](https://github.com/ray-project/ray) ⭐ 43,799 | 🐛 3,609 | 🌐 Python | 📅 2026-09-14 - A fast and simple framework for building and running distributed applications.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14,422 | 🐛 206 | 🌐 Go | 📅 2026-09-14 - distributed POSIX file system built on object storage.
...
* [TiKV](https://github.com/pingcap/tikv) ⭐ 16,842 | 🐛 1,814 | 🌐 Rust | 📅 2026-09-14 - a distributed key-value database powered by Rust and inspired by Google Spanner and HBase.
...
* [Tarantool](https://github.com/tarantool/tarantool) ⭐ 3,668 | 🐛 1,725 | 🌐 Lua | 📅 2026-09-14 - an efficient NoSQL database and a Lua application server.
...
* [AgensGraph](https://github.com/bitnine-oss/agensgraph) ⭐ 1,508 | 🐛 141 | 🌐 C | 📅 2026-09-14 - transactional graph database based on PostgreSQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 40,529 | 🐛 6,994 | 🌐 Go | 📅 2026-09-14 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [Cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,457 | 🐛 8,437 | 🌐 Go | 📅 2026-09-08 - Scalable, Geo-Replicated, Transactional Datastore.
* [yugabyteDB](https://github.com/YugaByte/yugabyte-db) ⭐ 10,534 | 🐛 8,419 | 🌐 C | 📅 2026-09-14 - open source, high-performance, distributed SQL database compatible with PostgreSQL.
...
* [Comdb2](https://github.com/bloomberg/comdb2) ⭐ 1,531 | 🐛 313 | 🌐 C | 📅 2026-09-11 - a clustered RDBMS built on optimistic concurrency control techniques.
...
* [TDengine](https://github.com/taosdata/TDengine/) ⭐ 25,115 | 🐛 434 | 🌐 C | 📅 2026-09-12 - open-source time-series database with high-performance ingestion, SQL support, and IoT-oriented storage.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,714 | 🐛 793 | 🌐 Go | 📅 2026-09-14 - fast, scalable and resource-effective open-source TSDB compatible with Prometheus. Single-node and cluster versions included
* [Thanos](https://github.com/improbable-eng/thanos) ⭐ 14,203 | 🐛 907 | 🌐 Go | 📅 2026-09-11 - Thanos is a set of components to create a highly available metric system with unlimited storage capacity using multiple (existing) Prometheus deployments.
* [Druid](https://github.com/druid-io/druid/) ⭐ 14,052 | 🐛 784 | 🌐 Java | 📅 2026-09-14 Column oriented distributed data store ideal for powering interactive applications
...
* [Spark Catalyst](https://github.com/apache/spark/tree/master/sql) ⭐ 43,996 | 🐛 541 | 🌐 Scala | 📅 2026-09-14 - is a Query Optimization Framework for Spark and Shark.
* [Materialize](https://github.com/materializeinc/materialize) ⭐ 6,367 | 🐛 733 | 🌐 Rust | 📅 2026-09-14 - is a streaming database for real-time applications using SQL for queries and supporting a large fraction of PostgreSQL.
* [chDB](https://github.com/chdb-io/chdb) ⭐ 2,897 | 🐛 44 | 🌐 Python | 📅 2026-09-14 - in-process OLAP SQL engine powered by ClickHouse, callable from Python with native pandas/Arrow DataFrame interop.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 46,106 | 🐛 1,417 | 🌐 Go | 📅 2026-09-14 - open-source vector database for scalable similarity search.
* [Zvec](https://github.com/alibaba/zvec) ⭐ 15,917 | 🐛 57 | 🌐 C++ | 📅 2026-09-14 - open-source, in-process vector database for dense, sparse, and hybrid similarity search.
...
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,331 | 🐛 1,728 | 🌐 Java | 📅 2026-09-14 - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,486 | 🐛 45 | 🌐 Go | 📅 2026-09-14 - an open source customer data infrastructure (segment, mParticle  alternative) written in go.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,961 | 🐛 22 | 🌐 Go | 📅 2026-09-14 - CLI tool for copying data between sources and destinations.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,705 | 🐛 58 | 🌐 Go | 📅 2026-09-14 - end-to-end data pipeline tool combining ingestion, transformations, and data quality checks.
* [Duckle](https://github.com/slothflowlabs/duckle) ⭐ 1,297 | 🐛 58 | 🌐 Rust | 📅 2026-09-11 - open-source visual ETL/ELT platform built on DuckDB with connectors, data quality checks, and lineage.
...
* [Spotify Luigi](https://github.com/spotify/luigi) ⭐ 18,773 | 🐛 175 | 🌐 Python | 📅 2026-07-18 - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
...
* [Apache Airflow](https://github.com/apache/incubator-airflow) ⭐ 46,855 | 🐛 2,136 | 🌐 Python | 📅 2026-09-14 - a platform to programmatically author, schedule and monitor workflows.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,150 | 🐛 2,585 | 🌐 Python | 📅 2026-09-14 - a data orchestrator for machine learning, analytics, and ETL.
* [Cronicle](https://github.com/jhuckaby/Cronicle) ⭐ 5,832 | 🐛 333 | 🌐 JavaScript | 📅 2026-09-11 - Distributed, easy to install, NodeJS based, task scheduler
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,077 | 🐛 3,162 | 🌐 C++ | 📅 2026-09-14 - Library from Google for machine learning using data flow graphs.
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,252 | 🐛 2,161 | 🌐 Python | 📅 2026-09-14 - scikit-learn: machine learning in Python.
* [Keras](https://github.com/fchollet/keras) ⭐ 64,321 | 🐛 191 | 🌐 Python | 📅 2026-09-14 - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
...
* [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/wiki) ⭐ 8,717 | 🐛 1 | 🌐 C++ | 📅 2026-09-14 - learning system sponsored by Microsoft and Yahoo!.
...
* [Aim](https://github.com/aimhubio/aim) ⭐ 6,251 | 🐛 473 | 🌐 Python | 📅 2026-09-13 - open-source AI metadata tracker for experiments and training runs.
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,414 | 🐛 407 | 🌐 C++ | 📅 2026-03-11 - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
...
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,247 | 🐛 4,341 | 🌐 Clojure | 📅 2026-09-14 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,136 | 🐛 1,019 | 🌐 TypeScript | 📅 2026-09-14 - The open source Looker alternative built on dbt
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 74,759 | 🐛 617 | 🌐 Python | 📅 2026-09-14 - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,316 | 🐛 1,501 | 🌐 TypeScript | 📅 2026-09-14 - Baidus enterprise charts.
* [Redash](https://github.com/getredash/redash) ⭐ 28,794 | 🐛 804 | 🌐 Python | 📅 2026-09-03 - open-source platform to query and visualize data.
* [Dash](https://github.com/plotly/dash) ⭐ 24,406 | 🐛 485 | 🌐 Python | 📅 2026-09-14 - Analytical Web Apps for Python, R, Julia, and Jupyter. Built on top of plotly, no JS required
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,216 | 🐛 1,482 | 🌐 Python | 📅 2026-09-13 - plotting with Python.
* [Plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,328 | 🐛 773 | 🌐 JavaScript | 📅 2026-09-14 The open source javascript graphing library that powers plotly.
* [Sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,164 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-14 - JavaScript library dedicated to graph drawing.
* [Vega](https://github.com/vega/vega) ⭐ 11,989 | 🐛 470 | 🌐 JavaScript | 📅 2026-09-11 - a visualization grammar.
...
* Even more lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,011 | 🐛 106 | 📅 2026-09-02.
* Public Datasets [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,948 | 🐛 158 | 📅 2026-09-14.
* Other awesome lists [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,670 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.
* Another list? [list](https://github.com/jnv/lists) ⭐ 11,480 | 🐛 27 | 📅 2026-03-23.
...
* WTF! [awesome-awesome-awesome](https://github.com/t3chnoboy/awesome-awesome-awesome) ⭐ 2,260 | 🐛 5 | 📅 2023-11-13.
